...
@Set WORKDRIVE=C
@Set JDK="%WORKDRIVE%:\Program Files\Java\jdk-11.0.2"
...
@REM set CLASSPATH=.;%JAVAPROG_CLASSES_FOLDER%
@set CLASSPATH=.;%JAVAPROJ_DIST_FOLDER%/%JAVAPROJ_JAR_FILE%
