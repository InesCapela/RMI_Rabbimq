...
@REM ==== PC STUFF ====
@Set JDK=%WORKDRIVE%:\Programas\Java\jdk1.8.0_211
...
@Set JAVA_RABBITMQ_TOOLS=%JAVA_LIB_FOLDER%\\amqp-client-5.9.0.jar;%JAVA_LIB_FOLDER%\\slf4j-api-1.7.26.jar;%JAVA_LIB_FOLDER%\\slf4j-simple-1.7.26.jar
@Set JAVA_ORGJASON_TOOLS=%JAVA_LIB_FOLDER%\\json-20190722-javadoc.jar

@REM Set CLASSPATH=%JAVAPROJ_CLASSES_FOLDER%;JAVA_RABBITMQ_TOOLS%
@REM Set CLASSPATH=%JAVAPROJ_JAR_FILE%
@Set CLASSPATH=%JAVAPROJ_JAR_FILE%;%JAVA_RABBITMQ_TOOLS%;%JAVA_ORGJASON_TOOLS%
