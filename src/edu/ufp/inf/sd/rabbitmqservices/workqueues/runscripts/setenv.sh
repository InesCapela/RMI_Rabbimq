...
export JAVAPROJ=/home/${USERNAME}/Documents/${JAVAPROJ_NAME}
...
export JAVA_RABBITMQ_TOOLS=${JAVA_LIB_FOLDER}/amqp-client-5.7.0.jar:${JAVA_LIB_FOLDER}/slf4j-api-1.7.26.jar:${JAVA_LIB_FOLDER}/slf4j-simple-1.7.26.jar
